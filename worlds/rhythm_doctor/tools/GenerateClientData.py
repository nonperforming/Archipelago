...
from worlds import rhythm_doctor
from worlds.rhythm_doctor.Data import _Stage, _RegularStage, _BossStage, \
    main_ward_stages, svt_ward_stages, train_stages, physiotherapy_ward_stages, other_stages, all_regular_stages, \
    act_1_boss, act_2_boss, act_3_boss, act_3_secret_boss, act_4_boss, act_5_boss, all_boss_stages, \
    all_stages
...
def build_internal_name_to_stage(world: "RhythmDoctorWorld") -> str:
    ...
    lesmis_constructor = (f"{world.location_name_to_id[f"{act_3_boss.name} - Clear"]}, "
                          f"null, "
